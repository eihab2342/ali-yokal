...
export default function HeroSection({}: { home?: Home; [key: string]: unknown } = {}) {
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-start">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-[#52b788]/40 bg-[#2d6a4f]/20 text-[#52b788] text-xs font-bold tracking-wider mb-6 animate-fade-in-up shadow-[0_0_20px_rgba(82,183,136,0.2)]">
              ...
              <span>د. علي ياقوت — دكتوراه في العلاج التحفظي وتجميل الأسنان</span>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full mb-8">
              <div className="p-3 rounded-2xl bg-[#141f1b] border border-[#52b788]/20 flex items-center gap-2.5 hover:border-[#52b788]/50 transition-colors">
                <Shield className="w-5 h-5 text-[#52b788] flex-shrink-0" />
                <span className="text-xs font-semibold text-[#f8fafc]/90">عزل Rubber Dam</span>
              </div>
              <div className="p-3 rounded-2xl bg-[#141f1b] border border-[#52b788]/20 flex items-center gap-2.5 hover:border-[#52b788]/50 transition-colors">
                <Clock className="w-5 h-5 text-[#52b788] flex-shrink-0" />
                <span className="text-xs font-semibold text-[#f8fafc]/90">ساعة لكل مريض</span>
              </div>
              <div className="p-3 rounded-2xl bg-[#141f1b] border border-[#52b788]/20 flex items-center gap-2.5 hover:border-[#52b788]/50 transition-colors">
                <Scan className="w-5 h-5 text-[#52b788] flex-shrink-0" />
                <span className="text-xs font-semibold text-[#f8fafc]/90">ماسح رقمي 3D</span>
              </div>
              <div className="p-3 rounded-2xl bg-[#141f1b] border border-[#52b788]/20 flex items-center gap-2.5 hover:border-[#52b788]/50 transition-colors">
                <Sparkles className="w-5 h-5 text-[#52b788] flex-shrink-0" />
                <span className="text-xs font-semibold text-[#f8fafc]/90">حشو تجميلي دقيق</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto">
              ...
              >
                <span>احجز استشارتك الخاصة</span>
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            ...
            <div className="relative w-full max-w-[420px] rounded-[2.5rem] overflow-hidden border-2 border-[#52b788]/40 bg-gradient-to-b from-[#141f1b] to-[#0c1311] shadow-[0_20px_60px_rgba(0,0,0,0.7)] group">
              ...
              <div className="relative h-[480px] sm:h-[540px] w-full overflow-hidden">
                <Image
                  src={doctorHeroImg}
                  alt="د. علي ياقوت - دكتوراه العلاج التحفظي وتجميل الأسنان"
                  fill
                  priority
